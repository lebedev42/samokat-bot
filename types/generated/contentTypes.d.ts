...
export interface ApiPlayerPlayer extends Schema.CollectionType {
  ...
  attributes: {
    name: Attribute.String;
    tgId: Attribute.Integer & Attribute.Unique;
...
export interface ApiTransactionTransaction extends Schema.CollectionType {
  ...
  attributes: {
    ofd_url: Attribute.String & Attribute.Unique;
    ofd_id: Attribute.String & Attribute.Unique;
    ofd_fp: Attribute.String;
    ...
    player: Attribute.Relation<
      ...
      'api::player.player'
    >;
    ofd_date: Attribute.String & Attribute.Unique;
    isCounted: Attribute.Boolean & Attribute.DefaultTo<false>;
